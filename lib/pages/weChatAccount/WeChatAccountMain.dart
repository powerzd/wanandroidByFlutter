...
import 'package:wanandroid/pages/weChatAccount/WeChatDetailData.dart' as prefix0;
...
class WeChatAccountMainState extends State<WeChatAccountMain> with SingleTickerProviderStateMixin{
...
//                  title: Text("213234"),
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Text(_lists[0].name,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20.0),),
                    ),
                  ),
                  Expanded(
                    child: Center(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          return ListTile(
                            onTap: (){
                              Navigator.pushNamed(context, "detail",arguments: {"address":_detailList[index].link});
                            },
  ...
  Future getBaseData() async{
    ...
    var baseResult = await Future.wait([
      ...
      baseDio.get(baseUrl + "wxarticle/list/408/1/json"),
    ]);
    var baseResultJson = json.decode(baseResult.toString());
    WeChatAccountData weChatAccountData = WeChatAccountData.fromJson(baseResultJson[0]);
    prefix0.WeChatDetailData weChatDetailData = prefix0.WeChatDetailData.fromJson(baseResultJson[1]);
    setState(() {
