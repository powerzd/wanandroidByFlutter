class HomePageProjectData {
    Data data;
    int errorCode;
    String errorMsg;

    HomePageProjectData({this.data, this.errorCode, this.errorMsg});

    factory HomePageProjectData.fromJson(Map<String, dynamic> json) {
        return HomePageProjectData(
